...
long long
fibModulo (long long n, long long m)
{
...
void
fibMPow (QuadMatrix *qm, int n, int m)
{
...
void
mModuloMulty (QuadMatrix *qm, QuadMatrix *qm1, int m)
{
...
void
copyQuadMatrix (QuadMatrix *source, QuadMatrix *dist)
{
...
void
IInitQuadMatrix (QuadMatrix *source)
{
  source->x_00 = 1;
  source->x_01 = 0;
  source->x_10 = 0;
...
void
fastBasicMPow (QuadMatrix *qm, int n, int m)
{
...
void
matrixModuloPow (QuadMatrix *qm, int n, int m)
{
  if (qm->is_fib)
    {
      fibMPow (qm, n, m);
